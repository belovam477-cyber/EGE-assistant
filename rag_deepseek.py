...
from langchain_openai import ChatOpenAI  # используем ChatOpenAI для DeepSeek

# --- Конфигурация ---
CHROMA_PATH = "./chroma_db"
EMBEDDING_MODEL = "intfloat/multilingual-e5-small"
DEEPSEEK_API_KEY = "sk-fe6c278f78514b51be27df9913e0beb8"  # ваш DeepSeek API ключ
...
# Инициализируем DeepSeek через OpenAI-совместимый класс
llm = ChatOpenAI(
...
Ответ:"""
    ...
    # Вызываем DeepSeek
    response = llm.invoke(prompt)  # возвращает AIMessage
    answer = response.content       # извлекаем текст ответа
